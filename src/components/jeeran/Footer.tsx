      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-8 pb-8 border-b border-cream/10">
          ...
          <div>
            ...
            <div className="flex">
              <input type="email" placeholder="بريدك الإلكتروني" className="flex-1 min-w-0 bg-background/10 border border-cream/20 px-3 py-2.5 text-sm focus:outline-none focus:border-gold" />
